package com.cloudsuite

import com.cloudsuite.config.ApplicationProperties
import com.cloudsuite.config.CRLFLogConverter
...
class FiscalApp(private val env: Environment) {
    ...
    companion object {
        ...
        fun main(args: Array<String>) {
            val env = runApplication<FiscalApp>(*args) { DefaultProfileUtil.addDefaultProfile(this) }.environment
            logApplicationStartup(env)
        }

        @JvmStatic
        private fun logApplicationStartup(env: Environment) {
            val log = LoggerFactory.getLogger(FiscalApp::class.java)
