...
import com.cloudsuite.config.AsyncSyncConfiguration
import com.cloudsuite.config.EmbeddedSQL
...
@SpringBootTest(classes = [FiscalApp::class, AsyncSyncConfiguration::class])
@EmbeddedSQL
