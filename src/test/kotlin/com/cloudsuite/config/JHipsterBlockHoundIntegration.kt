...
class JHipsterBlockHoundIntegration : BlockHoundIntegration {
    override fun applyTo(builder: BlockHound.Builder) {
        ...
        builder.allowBlockingCallsInside("com.cloudsuite.service.MailService", "sendEmailFromTemplate")
        builder.allowBlockingCallsInside("com.cloudsuite.security.DomainUserDetailsService", "createSpringSecurityUser")
